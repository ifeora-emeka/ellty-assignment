...
export default function EachPageItem({ id, label, checked = false, onChange }: Props) {
    ...
    return (
        <div className='group'>
            <label htmlFor={id} className='font-sans font-normal text-sm leading-[130%] tracking-[0px] align-middle flex items-center justify-between gap-2 py-[8px] pr-[15px] pl-[22px] cursor-pointer text-[14px]'>
                {label}
